								...
								<tr>
									...
									<td class="table-action">
										...
										<div class="dropdown-menu">
											...
											<a href="<?= base_url("admin/anime/genre/delete/$c->id") ?>" class="delete-confirm dropdown-item"><i class="mdi mdi-delete"></i> Delete</a>
										</div>
									</td>
								</tr>
							<?php endforeach ?>
...
<script>
	...
	function editype(id) {
		...
		xhttp.open("GET", "<?= base_url("admin/anime/genre/edit/") ?>" + id, true);
		xhttp.send();
	}
</script>
...
<div id="modal-add" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?= base_url("admin/anime/genre") ?>" method="post">
...
<div id="modal-edit" class="modal fade" tabindex="-1" role="dialog" aria-labelledby="standard-modalLabel" aria-hidden="true">
	<div class="modal-dialog">
		<div class="modal-content">
			...
			<form action="<?= base_url("admin/anime/genre/edit") ?>" method="post">
				<div class="modal-body">
