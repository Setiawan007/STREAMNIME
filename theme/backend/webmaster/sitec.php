	...
	<div class="col-12">
		<div class="card">
			<div class="card-body">
				<div class="row mb-2">
					<div class="col-sm-4">
						<a href="<?= base_url("admin/webmaster/sitec/create") ?>" class="btn btn-success mb-2"><i class="mdi mdi-plus-circle me-2"></i> New Type</a>
					</div>
					<div class="col-sm-8">
					...
					<tbody>
						<?php foreach ($type as $t) : ?>
							<tr>
								...
								<td><?= $t->type_title ?></td>
								<td><i class="<?= $t->type_icon ?>"></i></td>
								<td><?= ($t->type_status == 1) ? '<span class="badge bg-success">ON</span>' :  '<span class="badge bg-secondary">OFF</span>' ?></td>
								<td class="table-action">
									<a href="<?= base_url($t->type_slug) ?>" target="_blank" class="action-icon"> <i class="mdi mdi-eye"></i></a>
									<a href="<?= base_url("admin/webmaster/sitec/edit/$t->id") ?>" class="action-icon"> <i class="mdi mdi-square-edit-outline"></i></a>
									<a href="<?= base_url("admin/webmaster/sitec/delete/$t->id") ?>" class="action-icon delete-confirm"> <i class="mdi mdi-delete"></i></a>
								</td>
							</tr>
						<?php endforeach ?>
					</tbody>
