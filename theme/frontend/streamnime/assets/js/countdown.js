...
const countdown = function (_config) {
    ...
    $(_config.target + " .day .word").innerHTML = "Days";
    $(_config.target + " .hour .word").innerHTML = "Hours";
    $(_config.target + " .min .word").innerHTML = "Mins";
    $(_config.target + " .sec .word").innerHTML = "Secs";
